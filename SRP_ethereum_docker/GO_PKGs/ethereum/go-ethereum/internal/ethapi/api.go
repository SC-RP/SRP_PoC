...
func SubmitTransaction(ctx context.Context, b Backend, tx *types.Transaction) (common.Hash, error) {
	...
	if tx.To() == nil {
		...
		//log.Info("SCG: Starting Timer for submitted tx", "fullhash", tx.Hash().Hex(), "recipient", tx.To())
		//txhash := tx.Hash().Hex()
		// timestamp ResultSubmitted
		//core.SCG.TxRecords[txhash].Submitted = time.Now()
		// write data to json file
		//sm.WriteJSONFile(core.SCG.FileName, core.SCG.TxRecords)
