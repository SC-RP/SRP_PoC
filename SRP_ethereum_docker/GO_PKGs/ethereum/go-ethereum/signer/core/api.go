...
//---- SCGuard Modification to resolve cycle issue, avoid calling ethapi
...
//---- SCGuard Modification ends here (but also removed ethapi from all files in the package)
...
type ExternalAPI interface {
	...
	SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*SignTransactionResult, error)
...
func (api *SignerAPI) SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*SignTransactionResult, error) {
	var (
		err    error
	...
	response := SignTransactionResult{Raw: rlpdata, Tx: signedTx}
